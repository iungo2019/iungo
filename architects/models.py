...
class Architects(models.Model):
	...
	whatsapp_link = models.URLField(max_length=200, null=True)
	...
	def save(self, *args, **kargs):
		...
		super(Architects , self).save(*args, **kargs)
...
class ArchitectOffice(models.Model):
	architect = models.ForeignKey(Architects , on_delete=models.CASCADE)
	image = models.ImageField(upload_to='ArchitectOffice/' , blank=True , null=True)
	...
	class Meta:
		verbose_name = 'Architect Office'
		verbose_name_plural = 'Architects Office'
