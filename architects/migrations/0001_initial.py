    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('architect', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='architects.architects')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='architects.category'),
        ),
        migrations.AddField(
            model_name='architects',
            name='style',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='architects.style'),
        ),
        migrations.CreateModel(
            name='ArchitectOffice',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='ArchitectOffice/')),
                ('architect', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='architects.architects')),
            ],
            options={
